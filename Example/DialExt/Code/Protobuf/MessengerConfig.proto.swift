...
/// Source file "messenger_config.proto"
/// Syntax "Proto3"
...
public struct MessengerConfigRoot {
    public static let `default` = MessengerConfigRoot()
...
final public class MessengerConfig : GeneratedMessage {
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> MessengerConfig {
        return try MessengerConfig.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasSharingEndpoint {
            output += "\(indent) sharingEndpoint: \(String(describing: sharingEndpoint)) \n"
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> MessengerConfig.Builder {
...
extension MessengerConfig: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> MessengerConfig {
        return try MessengerConfig.Builder().mergeFrom(data: data, extensionRegistry:MessengerConfigRoot.default.extensionRegistry).build()
    }
