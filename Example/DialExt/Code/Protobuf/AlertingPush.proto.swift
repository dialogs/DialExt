...
final public class Localizeable : GeneratedMessage {
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Localizeable {
        return try Localizeable.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasLocKey {
            output += "\(indent) locKey: \(String(describing: locKey)) \n"
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Localizeable.Builder {
...
final public class Peer : GeneratedMessage {
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Peer {
        return try Peer.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if (hasType) {
        ...
        if hasStrId {
            output += "\(indent) strId: \(String(describing: strId)) \n"
        }
        output += unknownFields.getDescription(indent: indent)
        return output
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Peer.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
...
final public class AlertingPush : GeneratedMessage {
    ...
    public enum AlertBody {
        ...
        public static func getLocAlertBody(_ value:AlertBody) -> Localizeable? {
            switch value {
            case .locAlertBody(let messageValue): return messageValue
            default: return nil
            }
        }
        public func getLocAlertBody() -> Localizeable? {
            switch self {
            case .locAlertBody(let messageValue): return messageValue
            default: return nil
            }
        ...
        public static func getSimpleAlertBody(_ value:AlertBody) -> String? {
            switch value {
            case .simpleAlertBody(let otherValue): return otherValue
            default: return nil
            }
        }
        public func getSimpleAlertBody() -> String? {
            switch self {
            case .simpleAlertBody(let otherValue): return otherValue
            default: return nil
            }
    ...
    public enum AlertTitle {
        ...
        public static func getLocAlertTitle(_ value:AlertTitle) -> Localizeable? {
            switch value {
            case .locAlertTitle(let messageValue): return messageValue
            default: return nil
            }
        }
        public func getLocAlertTitle() -> Localizeable? {
            switch self {
            case .locAlertTitle(let messageValue): return messageValue
            default: return nil
            }
        ...
        public static func getSimpleAlertTitle(_ value:AlertTitle) -> String? {
            switch value {
            case .simpleAlertTitle(let otherValue): return otherValue
            default: return nil
            }
        }
        public func getSimpleAlertTitle() -> String? {
            switch self {
            case .simpleAlertTitle(let otherValue): return otherValue
            default: return nil
            }
    ...
    public fileprivate(set) var hasLocAlertBody:Bool {
        get {
            return AlertingPush.AlertBody.getLocAlertBody(storageAlertBody) != nil
        }
        set(newValue) {
        }
    }
    ...
    public fileprivate(set) var hasSimpleAlertBody:Bool {
        get {
            return AlertingPush.AlertBody.getSimpleAlertBody(storageAlertBody) != nil
        }
        set(newValue) {
        }
    }
    ...
    public fileprivate(set) var hasLocAlertTitle:Bool {
        get {
            return AlertingPush.AlertTitle.getLocAlertTitle(storageAlertTitle) != nil
        }
        set(newValue) {
        }
    }
    ...
    public fileprivate(set) var hasSimpleAlertTitle:Bool {
        get {
            return AlertingPush.AlertTitle.getSimpleAlertTitle(storageAlertTitle) != nil
        }
        set(newValue) {
        }
    }
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AlertingPush {
        return try AlertingPush.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasLocAlertBody {
        ...
        if hasSimpleAlertBody {
            output += "\(indent) simpleAlertBody: \(String(describing: simpleAlertBody)) \n"
        }
        if hasLocAlertTitle {
        ...
        if hasSimpleAlertTitle {
            output += "\(indent) simpleAlertTitle: \(String(describing: simpleAlertTitle)) \n"
        }
        if hasSound {
            output += "\(indent) sound: \(String(describing: sound)) \n"
        }
        if hasBadge {
            output += "\(indent) badge: \(String(describing: badge)) \n"
        }
        if hasPeer {
            output += "\(indent) peer {\n"
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public func setAlertBody(_ oneOf:AlertingPush.AlertBody) ->  AlertingPush.Builder {
            builderResult.storageAlertBody = oneOf
            return self
        }
        public func setAlertTitle(_ oneOf:AlertingPush.AlertTitle) ->  AlertingPush.Builder {
            builderResult.storageAlertTitle = oneOf
            return self
        }
        public var locAlertBody:Localizeable! {
            ...
            set (value) {
                builderResult.hasLocAlertBody = value != nil
        ...
        public var locAlertTitle:Localizeable! {
            ...
            set (value) {
                builderResult.hasLocAlertTitle = value != nil
        ...
        public var peer:Peer! {
            ...
            set (value) {
                builderResult.hasPeer = value != nil
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AlertingPush.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
