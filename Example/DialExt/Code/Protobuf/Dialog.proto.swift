...
final public class AppSharedDialog : GeneratedMessage {
    public typealias BuilderType = AppSharedDialog.Builder
    ...
    public fileprivate(set) var isGroup:Bool! = nil
    ...
    public fileprivate(set) var isReadOnly:Bool! = nil
    public fileprivate(set) var hasIsReadOnly:Bool = false

    public fileprivate(set) var accessHash:Int64! = nil
    public fileprivate(set) var hasAccessHash:Bool = false

    public fileprivate(set) var peerId:Int32! = nil
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialog {
        return try AppSharedDialog.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        ...
        if hasIsGroup {
            output += "\(indent) isGroup: \(String(describing: isGroup)) \n"
        }
        if hasTitle {
            output += "\(indent) title: \(String(describing: title)) \n"
        }
        ...
        if hasIsReadOnly {
            output += "\(indent) isReadOnly: \(String(describing: isReadOnly)) \n"
        }
        if hasAccessHash {
            output += "\(indent) accessHash: \(String(describing: accessHash)) \n"
        }
        if hasPeerId {
            output += "\(indent) peerId: \(String(describing: peerId)) \n"
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialog.Builder {
...
final public class AppSharedUser : GeneratedMessage {
    public typealias BuilderType = AppSharedUser.Builder
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedUser {
        return try AppSharedUser.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasId {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedUser.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
...
final public class AppSharedDialogListContext : GeneratedMessage {
    public typealias BuilderType = AppSharedDialogListContext.Builder
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialogListContext {
        return try AppSharedDialogListContext.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public var mainUser:AppSharedUser! {
            ...
            set (value) {
                builderResult.hasMainUser = value != nil
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialogListContext.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
...
final public class AppSharedDialogList : GeneratedMessage {
    public typealias BuilderType = AppSharedDialogList.Builder
    ...
    override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialogList {
        return try AppSharedDialogList.Builder.fromJSONToBuilder(data:data, options:options).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> AppSharedDialogList.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
...
extension AppSharedDialog.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = AppSharedDialog
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "id": return self.id
...
extension AppSharedUser.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = AppSharedUser
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "id": return self.id
...
extension AppSharedDialogListContext.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = AppSharedDialogListContext
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "dialogs": return self.dialogs
...
extension AppSharedDialogList.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = AppSharedDialogList
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "ids": return self.ids
