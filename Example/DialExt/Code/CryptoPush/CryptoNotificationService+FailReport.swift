...
public struct CryptoFailReport: CustomStringConvertible {
    ...
    public static func with(error: Error) -> CryptoFailReport {
        return CryptoFailReport.init(error: error, nonce: nil)
    }
